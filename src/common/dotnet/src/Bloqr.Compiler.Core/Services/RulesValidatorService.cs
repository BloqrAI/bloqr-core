...
public sealed class RulesValidatorService : IRulesValidatorService, IDisposable
{
    ...
    private readonly ILogger<RulesValidatorService> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RulesValidatorService"/> class.
    /// </summary>
    /// <param name="logger">The logger instance.</param>
    public RulesValidatorService(ILogger<RulesValidatorService> logger)
    {
