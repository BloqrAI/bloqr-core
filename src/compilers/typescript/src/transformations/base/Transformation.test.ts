...
import { AsyncTransformation, SyncTransformation, type Transformation } from './Transformation.ts';
import { type ITransformationContext, SourceType, TransformationType } from '../../types/index.ts';
...
Deno.test('Transformation - interface compatibility', async (t) => {
  await t.step(
    'SyncTransformation should be compatible with Transformation interface',
    async () => {
  ...
  await t.step(
    'AsyncTransformation should be compatible with Transformation interface',
    async () => {
