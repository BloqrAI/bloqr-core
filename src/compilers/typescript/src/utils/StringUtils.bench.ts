...
Deno.bench(
  'StringUtils.splitByDelimiterWithEscapeCharacter - with escapes',
  { group: 'split' },
  () => {
    for (let i = 0; i < 1000; i++) {
...
Deno.bench(
  'StringUtils.splitByDelimiterWithEscapeCharacter - preserve tokens',
  { group: 'split' },
  () => {
    for (let i = 0; i < 1000; i++) {
...
Deno.bench(
  'StringUtils.splitByDelimiterWithEscapeCharacter - long string',
  { group: 'split' },
  () => {
